...
var pallet = [
    new codeBlock(40,20,120,30,"code block"),
    new inputBlock(40,70,120,30,"input"),
    new outputBlock(40,120,120,30,"output"),
    new whileBlock(40,170,120,30,"while loop"),
    new ifBlock(50,220,100,100,"if"),
    new endIfBlock(85,340,30,30)
];
