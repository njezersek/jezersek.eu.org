...
<body>
    ...
    <main>
		...
		<div class="bar-cont">
			<div class="bar">
				<div class="tool-bar">
					<a href="#"><img src="media/foot.png" width="15px"><div>Follow</div></a>
					<a href="#"><img src="media/examples.png" width="15px"><div>Projects</div></a>
				</div>
				<div class="tool-bar">
					<a><div class="number">565</div><div>Followers</div></a>
					<a><div class="number">389</div><div>Folowing</div></a>
					<a><div class="number">91</div><div>Projects</div></a>
				</div>
			</div>
		</div>
		<?php
